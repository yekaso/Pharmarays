...
$(function() {
    ...
    function computeFieldReadiness() {
        ...
        var titleRemaining = titleCharLimit - $("#drugclass_name").val().length;
    ...
    $('#drugclass_name').on("propertychange input textInput", function() {
    ...
    $(".submit").on('click', function() {
        ...
        var name = $("#drugclass_name").val();
        var description = $("#drugclass_description").val();
        ...
        $.ajax({
            type: "POST",
            url: serverurl + "sys_admin/user_authorization/createdrugclass",
